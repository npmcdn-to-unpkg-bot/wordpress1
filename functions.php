...
// add_action('admin_head', 'my_admin_footer_function');
// function my_admin_footer_function() {
// 	echo '<script> var icl_ajx_url = "http://192.155.246.146:7176/wp-admin/admin.php?page=sitepress-multilingual-cms/menu/languages.php";</script>';
// }
